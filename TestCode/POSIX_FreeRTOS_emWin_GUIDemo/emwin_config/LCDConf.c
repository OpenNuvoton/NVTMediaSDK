...
#if DEF_MAPTO_OSD
		u8FrameBufPtr  = (UINT8 *)((UINT32)u8FrameBuf_OSD | 0x80000000);
#else
		u8FrameBufPtr  = (UINT8 *)((UINT32)u8FrameBuf_VIDEO | 0x80000000);		
#endif
...
void VPOST_VIDEO_Init()
{
	...
	vpostLCMInit(&lcdFormat, (UINT32*)u8FrameBuf_VIDEO);
}
...
void VPOST_OSD_Init()
{
	...
	#define DEF_OSD_COLORKEY	0x00000011
	vpostSetOSD_Transparent_Enable();
	vpostSetOSD_Transparent(eDRVVPOST_OSD_TRANSPARENT_RGB565, DEF_OSD_COLORKEY);
}
