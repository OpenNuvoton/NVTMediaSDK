...
#define ERR_IMGPROC_NOT_SUPP				(IMGPROC_ERRNO | 0x1)
#define ERR_IMGPROC_BAD_ATTR				(IMGPROC_ERRNO | 0x2)
#define ERR_IMGPROC_RES						(IMGPROC_ERRNO | 0x3)
#define ERR_IMGPROC_MALLOC					(IMGPROC_ERRNO | 0x4)
#define ERR_IMGPROC_COLOR_FORMAT			(IMGPROC_ERRNO | 0x5)
